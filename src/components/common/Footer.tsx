      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          <Grid item xs={12} sm={4} md={4}>
            ...
            <Typography variant="body2" color="grey.400" sx={{ mb: 3 }}>
               File Management is a secure, enterprise-grade system that streamlines file organization, collaboration, and recovery — all with intelligent automation and control.
            </Typography>
            ...
            <Box mt={4}>
              ...
              >
                <Typography variant="body2" color="grey.400">
                  Email: filemanagement@fincoopers.in
                </Typography>
              </Link>
        ...
        >
          <Typography variant="body2" color="grey.500">
            © {new Date().getFullYear()} File Management.
            All rights reserved.
          </Typography>
